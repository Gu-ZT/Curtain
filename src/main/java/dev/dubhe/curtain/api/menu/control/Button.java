...
public class Button {
    ...
    public Button(boolean defaultState, String key) {
        this(defaultState, Items.BARRIER, Items.STRUCTURE_VOID, 1,
                TranslationHelper.translate(key, ChatFormatting.GREEN, Style.EMPTY.withBold(true).withItalic(false), "on"),
                TranslationHelper.translate(key, ChatFormatting.RED, Style.EMPTY.withBold(true).withItalic(false), "off")
        );
    }
    ...
    public Button(boolean defaultState, Item onItem, Item offItem, int itemCount) {
        this(defaultState, onItem, offItem, itemCount,
                TranslationHelper.translate("on", ChatFormatting.GREEN, Style.EMPTY.withBold(true).withItalic(false)),
                TranslationHelper.translate("off", ChatFormatting.RED, Style.EMPTY.withBold(true).withItalic(false))
        );
    }
